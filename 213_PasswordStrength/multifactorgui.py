...
class MultiFactorAuth(tk.Tk):
  ...
  def set_authentication(self, user="admin", pw="SSH@rshaM201000#"):
    self.username = user
    self.password = pw
  ...
  def __init__(self):
    ...
    # show this authenticate frame
    self.frame_login.tkraise()

  # get the multi factor authenticate information and if authenticated, 
  ...
  def authenticate(self):
    ...
    if (student_username == self.username and  student_password == self.password):
        # authenticated - create authentication frame and widgets
